<head>
       <title>MaalDe - Admin Dashboard</title>
        <link rel="shortcut icon" href="../assets/login/images/maalde.png">
        <link rel="icon" type="image/png" href="assets/login/images/maalde.png"/>
