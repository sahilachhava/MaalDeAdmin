...
if(isset($_GET['login'])){
	$sql2 = "update subadmin_details set `subadmin_isonline`=1 where `subadmin_id`=".$_SESSION["user_id"];
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="page-title-box">
                                        <?php 
                                    		$sql = "select subadmin_name from subadmin_details where subadmin_id=".$_SESSION["user_id"];
