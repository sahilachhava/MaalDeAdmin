...
$n = $e = "";
$sql1 = "select * from admin_details where admin_id=".$_SESSION['user_id']; 
...
<?php
	if(isset($_POST['mail']))
	{
		...
		if($pass=="")
		{
			$sql = "update admin_details set admin_phone = '$mail' where admin_id=".$_SESSION['user_id']; 
			$result = mysqli_query($conn,$sql) or die(mysqli_error($conn));
			echo "<script type='text/javascript'>window.location.href='index.php'</script>";
		}
		else
		{
			$sql = "update admin_details set admin_phone =  '$mail' , admin_pass = '$pass' where admin_id=".$_SESSION['user_id']; 
			$result = mysqli_query($conn,$sql) or die(mysqli_error($conn));
			echo "<script type='text/javascript'>window.location.href='index.php'</script>";
		}
	}
